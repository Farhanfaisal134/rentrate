...
const ListingCard = ({
  ...
  return (
    <div
      className="relative cursor-pointer shadow-md w-72"
      onClick={() => {
        navigate(`/listings/${listingId}`)
      }}
    >
      <div className="w-72 overflow-hidden mb-2.5">
        <div
      ...
      <button
        className={`absolute right-2 top-2 border-none text-2xl cursor-pointer z-[999] bg-none ${isAddToWishList ? "text-red-500" : "text-white"
          }`}
        onClick={(e) => {
          e.stopPropagation()
          patchWishList()
