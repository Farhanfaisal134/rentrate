...
const CreateListing = () => {
  ...
  const handleSelectAmenities = (facility) => { // handleSelectAmenities(item.name)
          ...
          <div className="bg-white p-8 rounded-xl mt-10">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 px-5 md:px-0">
              {categories?.map((item, index) => (
                <div
                  className={`flex flex-col justify-center items-center w-28 h-20 border border-gray-300 rounded-lg cursor-pointer ${category === item.label ? "border-red-500 bg-gray-200" : ""
                    }`}
                  key={index}
            ...
            <div className="flex flex-col gap-5">
              {types?.map((item, index) => (
                <div
                  className={`flex justify-between gap-5 items-center max-w-2xl p-4 border border-gray-300 rounded-lg cursor-pointer ${type === item.name ? "border-red-500 " : ""
                    }`}
                  key={index}
          ...
          <div className="bg-white p-8 rounded-xl mt-10">
            ...
            <div className="flex flex-wrap gap-5">
              {facilities?.map((item, index) => (
                <div
                  className={`flex flex-col justify-center items-center w-52 h-24 border border-gray-300 rounded-lg cursor-pointer ${amenities.includes(item.name)
